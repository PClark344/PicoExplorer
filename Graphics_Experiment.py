...
while True:
    ...
    print(RAINBOW)
    display.set_pen(RAINBOW)  # Set pen - sets screen colour to random RAINBOW number
    # display.set_pen(4045)  # Set pen - sets screen colour - good values 16632,59655,57089
    display.clear()           # Fill the screen with the colour
    display.set_pen(BLACK)    # Set pen to black
    
    display.text("Ahoy!", 10, 10, 240, 6)  # Add some text
    
    display.text("|:-) |:-) |:-) |:-) |:-) |:-) |:-) |:-) |:-) |:-)", 25, 120, 240, 4)  # and some more text
    display.text("oo oo Typhoo Tea", 25, 220, 240, 2)  # and a bit more tiny text
